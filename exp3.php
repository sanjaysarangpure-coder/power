  ...
  <div id="theory_page" class="w3-container">
    ...
    <div class="w3-row">
      ...
      <div class="w3-col m10 w3-container">
        <h4>Half Wave Controlled Rectifier <span class="w3-opacity w3-medium"></span></h4>
        <p>A Single Phase Half Wave Controlled Rectifier circuit consists of SCR / thyristor, an AC voltage source and load. The load may be purely resistive, Inductive or a combination of resistance and inductance. A simple circuit diagram of Single Phase Half Wave Controlled Rectifier is shown in figure below.</p><br>
...
SCR will only turn off when current through it reaches below holding current and reverse voltage is applied for a time period more than the SCR turn off time. Thyristor T is forward biased for the positive half cycle of supply voltage. The load output voltage is zero till SCR is fired. Once SCR is fired at an angle of α, SCR starts conducting. But as soon as the supply voltage becomes zero at ωt = π, the load current will become zero and after ωt = π, SCR is reversed biased. Thus thyristor T will turn off at ωt = π and will remain in OFF condition till it is fired again at ωt = (2π+α).</p>

<br>
        <img src="./test1_files/half.jpg" style="max-width:100%;">
      </div>
    </div>    
  </div>
