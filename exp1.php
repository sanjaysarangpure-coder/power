...
<nav class="w3-sidebar w3-collapse w3-white w3-animate-left" style="z-index:3;width:300px;" id="mySidebar"><br>
  ...
  <div class="w3-container ">    
    <div class="w3-col s8 w3-bar" id="menu_user_edit_logout" >
       ...
       <a  class="w3-bar-item w3-button" onclick="theory_page()"><i class="fa fa-table"></i><span><strong>Theory</strong></span></a>
      <a  class="w3-bar-item w3-button" onclick="component_page()"><i class="fa fa-microchip"></i><span><strong>Component</strong></span></a>
      <a  class="w3-bar-item w3-button" onclick="circuit_page()"><i class="fa fa-tasks"></i><span><strong>Procedure</strong></span></a>
      <a  class="w3-bar-item w3-button" onclick="simulation_page()"><i class="fa fa-laptop"></i><span><strong>Simulation</strong></span></a>
  ...
  <div id="theory_page" class="w3-container">
    ...
    <div class="w3-row">
      ...
      <div class="w3-col m10 w3-container">
        <h4>SCR Resistance Trigerring  <span class="w3-opacity w3-medium"></span></h4>
        <p>There are several SCR Turn On (Triggering) Methods depending various entities like voltage, temperature etc. SCR Resistive Trigerring method is belon to Gate Triggering  type. This is most common and most efficient method to turn ON the SCR. When the SCR is forward biased, a sufficient positive voltage at the gate terminal injects some electrons into the junction J2. This results in an increase in the reverse leakage current and hence the breakdown of junction J2 occurs even at a voltage lower than the VBO. In gate triggering method, a positive voltage applied between the gate and the cathode terminals.</p><br>
        <p>The circuit below shows the resistance triggering of SCR where it is employed to drive the load from the input AC supply. Resistance and diode combination circuit acts as a gate control circuitry to switch the SCR in the desired condition.
As the positive voltage applied, the SCR is forward biased and doesn’t conduct until its gate current is more than minimum gate current of the SCR. When the gate current is applied by varying the resistance R2 such that the gate current should be more than the minimum value of gate current, the SCR is turned ON. And hence the load current starts flowing through the SCR.
...
In this, the triggering angle is limited to 90 degrees only. Because the applied voltage is maximum at 90 degrees so the gate current has to reach minimum gate current value somewhere between zero to 90 degrees.</p>
<br>
        <img src="./test1_files/rtrigger.jpg" style="max-width:100%;">
...
<div id="simulation_page" style="display: none;" class="w3-container">
    ...
    <div class="w3-row">
      ...
      <div style="background-color: #FFFFFF;">
      <a class="w3-bar-item w3-button"><i class="fa fa-sign-out"></i><span><strong>Potentiometer: 0-100K Ohm</strong></span></a>
...
<script>
      ...
      function onloadnew(val){
        var val_new=val/4;    /////////r trigerring method
        var firing_angle_val=(val/4)*10;
