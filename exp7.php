...
When the applied voltage in either polarity exceeds the breakdown voltage, DIAC current rises and the device conducts in accordance with its V-I characteristics. When MT2 and MT1 terminal of DIAC are connected to Negative and Positive terminal variable voltage source. Then VI characteristic will appear in third quadrant.</p><br>
        <img src="./test1_files/diacRB.jpg" style="max-width:100%;">
      </div>
    </div>    
  </div>
    ...
    <div class="w3-row-padding" style="margin:0 -16px">
      ...
      <div  class="w3-twothird"  style="display: block;">
        ...
        <table class="w3-table w3-striped w3-white">
          <tbody><tr>
            <td>1</td>
            <td><a >MT2 and MT1 terminal of DIAC are connected to Negative and Positive terminal variable voltage source</a><i></i></td>
          </tr>
          <tr>
            <td>2</td>
...
// Define Layout
const layout = {
  xaxis: {range: [-30, 0], title: "Voltage across SCR"},
  yaxis: {range: [-0.05,0 ], title: "Current throuhgh SCR"},  
